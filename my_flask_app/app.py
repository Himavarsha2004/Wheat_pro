...
def load_expected_columns(model_name):
    expected_columns_path = os.path.join('C:\\Users\\venka\\Downloads\\pro\\pro\\models\\', f'{model_name}_columns.joblib')
...
for pooled_value in pooled_values:
    model_path = f'C:\\Users\\venka\\Downloads\\pro\\pro\\models\\{pooled_value}_model.joblib'
    model = joblib.load(model_path)
    models[pooled_value] = model

    # Check if the expected columns file exists before attempting to load
    expected_columns_path = os.path.join('C:\\Users\\venka\\Downloads\\pro\\pro\\models\\', f'{pooled_value}_columns.joblib')
    if not os.path.exists(expected_columns_path):
        raise FileNotFoundError(f"No such file: {expected_columns_path}")

    expected_columns = joblib.load(expected_columns_path)

df = pd.read_csv("C:\\Users\\venka\\Downloads\\pro\\pro\\allele_file.csv")
...
def input_csv():
    ...
    csv_file_path = 'C:\\Users\\venka\\Downloads\\pro\\pro\\my_flask_app\\static\\csv\\input.csv'
...
def output_csv():
    # Replace 'your_csv_file_path.csv' with the actual path to your CSV file
    csv_file_path = 'C:\\Users\\venka\\Downloads\\pro\\pro\\my_flask_app\\static\\csv\\output.csv'
