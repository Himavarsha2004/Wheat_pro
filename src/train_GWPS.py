...
def train_model(file_path):
    ...
    pooled_file_path = 'C:\\Users\\venka\\Downloads\\pro\\pro\\models\\GWPS_Pooled_model.joblib'
    ...
    joblib.dump(expected_columns.tolist(), 'C:\\Users\\venka\\Downloads\\pro\\pro\\models\\GWPS_Pooled_model.joblib')
    joblib.dump(predictions, pooled_file_path)

    # Save the model
    model_file_path = 'C:\\Users\\venka\\Downloads\\pro\\pro\\models\\GWPS_Pooled_model.joblib'
    joblib.dump(predictions, pooled_file_path)
    joblib.dump(model, model_file_path)

    # Print the paths for confirmation
    print(f"Columns used during training saved to: C:\\Users\\venka\\Downloads\\pro\\pro\\models\\GWPS_Pooled_model.joblib")
