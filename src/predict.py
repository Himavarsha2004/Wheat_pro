...
def load_model(model_name):
    model_path = f'C:\\Users\\venka\\Downloads\\pro\\pro\\models\\{model_name}_model.joblib'
    if not os.path.exists(model_path):
        raise FileNotFoundError(f"No such file: {model_path}")
    return joblib.load(model_path)

def load_expected_columns(model_name):
    expected_columns_path = f'C:\\Users\\venka\\Downloads\\pro\\pro\\models\\{model_name}_columns.joblib'
...
if __name__ == "__main__":
    ...
    allele_file_path = 'C:\\Users\\venka\\Downloads\\pro\\pro\\allele_file.csv'
