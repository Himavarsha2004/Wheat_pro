...
def train_model(file_path):
    ...
    pooled_file_path = 'C:\\Users\\venka\\Downloads\\pro\\pro\\models\\DH_Pooled_model.joblib'
    ...
    joblib.dump(expected_columns.tolist(), 'C:\\Users\\venka\\Downloads\\pro\\pro\\models\\DH_Pooled_model.joblib')

    # Save the model
    model_file_path = 'C:\\Users\\venka\\Downloads\\pro\\pro\\models\\DH_Pooled_model.joblib'
    joblib.dump(model, model_file_path)

    # Print the paths for confirmation
    print(f"Columns used during training saved to: C:\\Users\\venka\\Downloads\\pro\\pro\\models\\DH_Pooled_model.joblib")
