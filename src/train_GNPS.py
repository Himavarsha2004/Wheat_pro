...
def train_model(file_path):
    ...
    pooled_file_path = 'C:\\Users\\venka\\Downloads\\pro\\pro\\models\\GNPS_Pooled_model.joblib'
    ...
    joblib.dump(expected_columns.tolist(), 'C:\\Users\\venka\\Downloads\\pro\\pro\\models\\GNPS_Pooled_model.joblib')

    # Save the model
    model_file_path = 'C:\\Users\\venka\\Downloads\\pro\\pro\\models\\GNPS_Pooled_model.joblib'
    joblib.dump(model, model_file_path)

    # Print the paths for confirmation
    print(f"Columns used during training saved to: C:\\Users\\venka\\Downloads\\pro\\pro\\models\\GNPS_Pooled_model.joblib")
    print(f"Model saved to: {model_file_path}")

# Example usage
if __name__ == "__main__":
    file_path = "C:\\Users\\venka\\Downloads\\pro\\pro\\allele_file.csv"
